                ...
                <ol className="flex   grid md:grid-cols-4 sm:grid-cols-4  branch-timeline-list ">                 
                  <li>
                    ...
                    <div className='txt-handler-bottom'>
                        <p className='text-[#808D9A] lg:text-[1rem] text-[0.75rem] text-center'>
                  ...
                  <li>
                   <div className="txt-handler">
                    <p className='text-[#808D9A] lg:text-[1rem] text-[0.75rem] text-center'>Transfer of data to and from branches using dial-up / web connectivity using Data transfer features of database to prevent handling errors and tampering.</p>
                    </div>
                    <div className="img-handler-bottom">   
                    <Img4/>
                    </div>
