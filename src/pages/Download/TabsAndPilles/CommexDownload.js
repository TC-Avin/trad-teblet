  ...
  return (
    <div className='bg-white'>
      <div className='bg-[#fffff]'>
        ...
        <div className='mb-6 text-lg text-center text-[#808D9A] font-normal px-[10rem] pb-12'>CDSL Record Organiser & Support System software for managing all activities in DP’s office. It offers a lot more facilities and security than CDAS system like stationery management, signature verification, current holding, dues etc. </div>
      </div>
