  ...
  return (
    <div>
      <div className='bg-[#fffff]'>
        ...
        <div className='mb-6 text-lg text-center text-[#808D9A] font-normal pb-12'>This Electronic  Security Treasury Records Organiser provides back office / front office coordination, billing and accounting software for DPs with NSDL.</div>
      </div>
      <div className='flex justify-between px-12 download-sliders'>

        <div className='relative'>

          <h2 className="left-[27%] top-[-22px] absolute text-center text-2xl font-medium text-[#000000]">
            Head Office
          </h2>
        ...
        <div className='relative'>
          ...
          <h2 className="left-[10%] top-[-22px] absolute text-center text-2xl font-medium text-[#000000]">
        ...
        <div className='relative'>
          ...
          <h2 className="left-[20%] top-[-22px] absolute text-center text-2xl font-medium text-[#000000]">
            Knowledge Base
          </h2>
          <Slider  {...settings} className="slider-card pb-12">
