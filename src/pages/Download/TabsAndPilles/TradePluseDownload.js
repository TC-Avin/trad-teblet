...
const ForwardArrow = (props) =>{
  return (
    <button type="button" onClick={props.onClick} class="back-forword-btn  bg-white m-3 z-50 text-blue-700 border border-blue-700 hover:bg-[#3491FF]   hover:text-white focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800
    absolute right-[4%] 
    ">
    <svg className="stroke-[#3491ff] hover:stroke-[#ffffff]" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const TradePluseDownload = () => {
  ...
  return (
    <div className='bg-[#F4FAFF]' >
        <div  id="trade-plus-download-section">
        <div className='font-medium text-3xl mb-4	text-center pt-12 text-[#0A2A4A]'>Trade Plus & TradeNet</div>
        <p className='mb-6 text-lg text-center text-[#808D9A] font-normal pb-12 px-8'>Facilitates in-depth reports and trade screens while ensuring security for each individual user.</p>
        </div>
      ...
      <Slider  {...settings} className="slider-card pb-12">
        <SliderCard  subTitle='TradeplusX EXE' img={'/assets/img/svg-1.png'} arrow={true}/>
        <SliderCard  subTitle='Tradeplus EXE' img={'/assets/img/svg-1.png'} arrow={true}/>
        <SliderCard  subTitle='E-Sign Pro' img={'/assets/img/svg-1.png'} arrow={true}/> 
        <SliderCard  subTitle='DB Support' img={'/assets/img/svg-1.png'} arrow={true}/> 
        <SliderCard  subTitle='Uttility' img={'/assets/img/svg-1.png'} arrow={true}/> 
      </Slider >
      </div>
      <div className='relative'>
...
Branch & Individual Client
    ...
    <Slider  {...settings} className=" slider-card pb-12">
      <SliderCard  subTitle='TradeNet' img={'/assets/img/svg-7.svg'} arrow={true}/>
      <SliderCard  subTitle='TradeNetx' img={'/assets/img/svg-7.svg'} arrow={true}/>
      <SliderCard  subTitle='TradeWeb' img={'/assets/img/svg-7.svg'} arrow={true}/>
      <SliderCard  subTitle='Framework' img={'/assets/img/svg-7.svg'} arrow={true}/>
    </Slider>
    </div>
    <div className='relative'>
...
Knowledge Base
    ...
    <Slider  {...settings} className=" slider-card pb-12">
    <SliderCard  subTitle='Circular' img={'/assets/img/svg-6.svg'} arrow={false}/>
    <SliderCard  subTitle='Help' img={'/assets/img/svg-6.svg'} arrow={false}/>
    <SliderCard  subTitle='Modifications' img={'/assets/img/svg-6.svg'} arrow={false}/>
    </Slider>
