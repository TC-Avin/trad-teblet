        ...
        <div className="container px-5 py-12 mx-auto ">
            ...
            <div className='relative top-[-10rem]' >
              <div className="rounded-full w-[15rem] h-[15rem] mx-auto  mt-10 bg-gradient-to-r p-[12px] from-[#0080F6]  via-[#05C876]  to-[#6EE7B7] relative">
                ...
                <img src={C2} className="w-full absolute top-[30px] left-[-29px] min-w-[22rem] max-w-[30rem] z-[-10]"  />
            </div>
            ...
            <div className='relative right-[2rem]' >
              <div className="rounded-full w-[15rem] h-[15rem] mx-auto  mt-10 bg-gradient-to-r p-[12px] from-[#0080F6]  via-[#05C876]  to-[#6EE7B7] relative">
                ...
                <img src={C1} className="w-full absolute bottom-[-14px] left-[-16%] min-w-[22rem] max-w-[30rem] z-[-10]"  style={{borderRadius:'0% 100% 0% 0%'}}  />
            </div>
