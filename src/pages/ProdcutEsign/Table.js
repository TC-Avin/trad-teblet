...
function Table() {
  ...
  <div className="container px-5 py-8 mx-auto">
    ...
    <p className=" leading-relaxed text-[1rem] text-[#808d9a]  lg:px-[19rem] pb-6">Acer eSolutions Pvt. Ltd. has now incorporated capability to digitally sign documents in it’s back office software as:</p>
    </div>
  ...
  <div className="flex flex-col text-center w-full mb-10 px-5 ">
      <p className=" title-font font-normal text-[#808d9a] text-[1rem] bg-[#ffffff] text-center lg:pl-[10rem] lg:pr-[10rem]">The above back-office packages will have option to digitally sign the documents before they are e-mailed. Client can have various persons signing the document and when there are multiple IDs installed on same machine, it shall ask for the person who is to sign the document and his associated password.</p>
    </div>
</section>
    </>
  )
