...
const Reports = () => {
    return (
        <section className="text-gray-600 body-font bg-[#ffffff] px-10 py-12 reports-list">
            ...
            <div className='container mx-auto'>
                {initalpagegraph.map((value, index) => (
                    <ul className={`report-list report-sesson relative border-l-4 ml-11 border-[#3491FF] dark:border-dark px-5 py-6 ${index % 2 ? "bg-[#FFFFFF]"  : "bg-[#F4FAFF]"}`}>
