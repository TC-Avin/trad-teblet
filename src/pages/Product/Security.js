    ...
    <>
      <section id="security-section " >
        <div className='container mx-auto' >
          ...
          <div className='md:px-14 side-section relative flex grid-cols-1 ' >
            <div className='relative w-full md:px-10  mt-[30px]' >
              ...
              <div className='flex justify-left items-center pb-3  ' >
                <Poligon className="md:ml-[9rem] relative" counting="05" />
                <LineImg className=" w-[24rem] relative" />
                <p className='w-[60%] text-[#808D9A] lg:text-[18px] text-[12px] ml-[2rem] '>
              ...
              <div className='flex justify-left items-center pb-3  ' >
                <Poligon className="md:ml-[5rem] relative" counting="06" />
                <LineImg className=" w-[28rem] relative" />
                <p className='w-[60%] text-[#808D9A]  lg:text-[18px] text-[12px] ml-[2rem] '>
