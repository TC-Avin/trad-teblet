...
const Navbar = ({ data }) => {
console.log("🚀 ~ file: Navbar.js ~ line 5 ~ Navbar ~ data", data)
    ...
    return (
        <>
            <nav className=" border-gray-200  py-5">
                <div ref={ref} className="container flex justify-between items-center mx-auto ">
                    ...
                    <div
                        className="justify-between items-center md:w-full md:flex md:w-auto md:order-1 mx-auto"
                        id="mobile-menu-2"
                    >
                        <ul className="flex mt-0 md:flex-row md:mt-0 md:text-sm  md:font-medium justify-content-left items-left">
                            {data.map(val => (
