...
function Footer() {
    return ( < >
        ...
        <a class = "mr-3 text-[#FFFFFF] text-sm font-small sm:text-sm md:text-sm border-r-2 sm:border-[#fff] pr-3 font-light flex align-center items-center " >
        <img src = "/assets/icons/lion.svg"
        className = "w-14 mr-2" />
        <span >
        Make in India </span>  
        </a> 
        <a className="text-[#FFFFFF] text-sm font-small sm:text-sm md:text-sm  font-light" >Powered by SecMark Consultancy Limited  </a>
        </nav>  
        </div> 
